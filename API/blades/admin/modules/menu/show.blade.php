    ...
    <div class="col-12">
        <div class="card" style="overflow: hidden">
            <div class="card-header">
                <h3 class="card-title">
                    <a href="{{ route($moduleName .'.add') }}" class="btn btn-info"><i class="fas fa-plus fa-md"></i> Add Item</a>
                </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                            ...
                            <td>
                                <div style="position:relative">
                                    ...
                                    <div class="hideOnMove" style="position:absolute; top:-6px; right:0px;">
                                        <a style="text-align:right" href="{{ route($moduleName.'.edit', $item->lang_id) }}"><i class="fas fa-edit btn btn-warning fa-sm mr-1"></i></a>
                                        <a style="text-align:right" href="{{ route($moduleName.'.delete', $item->lang_id) }}"><i class="fas fa-trash btn btn-danger fa-sm ml-1"></i></a>
                                    </div>
                                </div>
                            </td>
                        </tr>
